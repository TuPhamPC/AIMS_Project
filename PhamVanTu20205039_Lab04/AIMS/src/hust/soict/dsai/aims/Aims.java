...
import hust.soict.dsai.aims.media.Playables;
...
public class Aims {
                    ...
                    if (media != null) {
                        ...
                        switch (option3) {
                            ...
                            case 2:
                                ...
                                // is not playable”.
                                if (media instanceof Playables) {
                                    ((Playables) media).play();
                                } else {
    ...
    public static void makeCD() {
        ...
        keyboard = new Scanner(System.in);
        String author = keyboard.nextLine();
        CompactDisc cd = new CompactDisc(title, category, cost, director, length, author);
        store.add(cd);
    }
        ...
        while (true) {
            ...
            switch (option) {
                case 1:
                    ...
                    switch (option2) {
                        case 1:
                            System.out.println("Enter id  media you want to filter");
                            keyboard = new Scanner(System.in);
                            int id = keyboard.nextInt();
                            cart.filterById(id);
                            break;
